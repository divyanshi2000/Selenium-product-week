...
def signup():
    ...
    time.sleep(2)
    driver.find_element(By.XPATH,value="//input[@type='password']").send_keys("De@123")
    time.sleep(2)
    ...
    time.sleep(2)
    # check assertion
    actual_title = driver.find_element(By.CSS_SELECTOR,'body > app-root > app-sign-up > div > div.right > form > div:nth-child(4) > div').text
    print(actual_title)
    expected_title = ' Password is required with minimum length of 8 characters!!! '
    assert actual_title == expected_title
