...
def Allrecruitment():
    ...
    time.sleep(5)
    driver.find_element(By.XPATH,value="/html/body/app-root/app-all-recruitments/div/div[2]/div/app-card[2]/div/div").click()
    time.sleep(15)
    driver.find_element(By.CSS_SELECTOR,value="#results").send_keys("C:\\Training period\\Manual product week\\score.csv")
    time.sleep(5)
    driver.find_element(By.CSS_SELECTOR,value="#myModal > div > div > div.modal-header > button").click()
    time.sleep(5)
    driver.find_element(By.CSS_SELECTOR,value="body > app-root > app-recruitment-completed > ngb-alert > button").click()
    # check assertion
