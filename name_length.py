...
def signup():
    ...
    driver.find_element(By.XPATH,value="//input[@type='text']").send_keys("an")
    time.sleep(2)
    ...
    time.sleep(2)
    # check assertion
    actual_title = driver.find_element(By.CSS_SELECTOR,'body > app-root > app-sign-up > div > div.right > form > div:nth-child(1) > div').text
    print(actual_title)
    expected_title = ' Name is required with minimum length of 4 characters!!! '
    assert actual_title == expected_title
